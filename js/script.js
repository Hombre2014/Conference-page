...
function showSpeakers() {
  for (let i = 0; i < 6; i += 1) {
    ...
    speakerName[i].innerText = speakers[i].bio[0];
    company[i].innerText = speakers[i].bio[1];
    speakerText[i].innerText = speakers[i].bio[2];
  }
}
